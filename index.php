...
<section class="imagen-contacto">
    ...
    <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Reiciendis ratione sapiente unde suscipit, placeat
        dolorem, alias eius minima itaque molestias deleniti vero totam, velit nemo beatae! Ea rem ullam quibusdam.
    </p>
...
<div class="contenedor seccion seccion-inferior">
    <section class="blog">
        ...
        <article class="entrada-blog">
            ...
            <div class="texto-entrada">
                <a href="entrada.php">
                    <h4>Terraza en el techo de tu cassa</h4>
    ...
    <section class="testimoniales">
        ...
        <div class="testimonial">
            <blockquote>
                El personal se comportó de una excelente forma, muy buena atención y la casa quue me ofrecieron
                cumple con todas mis expectativas.
            </blockquote>
            <p>- Adrián Hernández</p>
        </div>
